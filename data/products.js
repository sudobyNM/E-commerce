...
export  async function loadProducts(){
  ...
  return products
    ...
    console.error("Error fetching from server:", 'try again later'); 
  }
}
...
//get products from xhr request
// export function loadProducts(callFun) {
//   const xhr = new XMLHttpRequest();

//   xhr.addEventListener("load", () => {
//     const responseData = JSON.parse(xhr.response);
//     products = responseData.map((productDetails) => {
//       return new Product(productDetails);
//     });
//     callFun();
...
//   }
//   display(){
//     return `${this.#brand} - ${this.#model}, ${this.#speed} km`
//   }
// }
